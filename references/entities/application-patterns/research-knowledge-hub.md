...
A research and knowledge hub preserves sources as records while turning
reviewed claims and syntheses into navigable knowledge. The repeating unit is a
source, claim, experiment, or reviewed synthesis.
...
- a source catalog and uniform source records;
- provenance, evidence status, and withdrawal or contradiction handling;
- candidate claims separated from approved synthesis;
- a small knowledge router and cross-links;
- a promotion log showing what changed and why.

The flow is: acquire or reference → normalize metadata → extract or synthesize
with provenance → review → promote into the navigable bundle.
